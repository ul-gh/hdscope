...
axhline1 = ax1.axhline(y=0., color="r")
axvline2 = ax2.axvline(x=0., color="k")


def onMouseMove(event):
  axvline1.set_data([event.xdata, event.xdata], [0, 0.0001])
  #axhline1.set_data([0, 1], [event.ydata, event.ydata])
  axhline1.set_data([0, 0.5], [event.ydata, event.ydata])
  axvline2.set_data([event.xdata, event.xdata], [0, 0.0001])
